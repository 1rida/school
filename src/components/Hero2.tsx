...
export default function Hero2() {
  return (
    <main className="w-full bg-white min-h-screen">
      <section className="relative z-0 max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        {/* 🔹 Image Side */}
        ...
        <div className="order-1 md:order-2 relative bg-white">
          ...
          <div className="space-y-6 relative bg-white">
            ...
            <p className="text-gray-700 leading-relaxed">
              At GEHSS, our team of passionate educators is committed to
              nurturing the minds of future leaders. With years of experience,
              they ensure a supportive and inspiring environment for every
              student.
            </p>
